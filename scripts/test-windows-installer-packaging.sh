...
grep -q 'validateOk' "$ROOT_DIR/scripts/package-windows-runtime.sh"
grep -q 'serviceInstalled' "$ROOT_DIR/scripts/package-windows-runtime.sh"
grep -q 'programDataStatusCaptured' "$ROOT_DIR/scripts/package-windows-runtime.sh"
grep -q 'stopVerified' "$ROOT_DIR/scripts/package-windows-runtime.sh"
grep -q 'Wait-ForState -Expected "stopped"' "$ROOT_DIR/scripts/package-windows-runtime.sh"
